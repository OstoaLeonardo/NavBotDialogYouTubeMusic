...
public class MainActivity extends AppCompatActivity {
    ...
    private void showBottomDialog() {
        ...
        LinearLayout titleLayout = dialog.findViewById(R.id.layoutTitle);
        LinearLayout descriptionLayout = dialog.findViewById(R.id.layoutDescription);
        LinearLayout privacyLayout = dialog.findViewById(R.id.layoutPrivacy);
        LinearLayout buttonsLayout = dialog.findViewById(R.id.layoutButtons);
